...
const ExternalWalletsPage: React.FC = () => {
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="space-y-6">
            <p className="text-sm px-1" style={{ color: colors.textLight }}>
              Deposit USDT directly from external sources. Scan the QR code or
            ...
            >
              ...
              <div className="w-full space-y-2">
                ...
                >
                  ...
                  >
                    {address ? formatAddress(address) : "Loading address..."}
                  </code>
                  <div className="flex gap-2">
                    <button
                      onClick={handleCopy}
                      disabled={!address || isInitializing}
            ...
            <div className="space-y-4 px-1">
              ...
              <div className="space-y-3">
                {[
                  {
                    step: 1,
                    title: "Select Avalanche Network",
                    desc: "Ensure you choose the Avalanche network on your exchange.",
                  },
                  {
                    step: 2,
                    title: "Select Token",
                    desc: "Choose USDT as the token to deposit (Supports USDT only).",
                    icon: (
                      <Image
            ...
            >
              ...
              <div className="space-y-1">
                ...
                >
                  <li>
                    Send only <b>USDT</b> to this address.
                  </li>
                  <li>
                    Ensure you are using the <b>Avalanche</b> network.
                  </li>
                  <li>
...
export default ExternalWalletsPage;
